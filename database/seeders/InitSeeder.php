...
class InitSeeder extends Seeder {
  ...
  public function run() {
    ...
    $permissions = [
      ...
      'organization-index', 'organization-create', 'organization-update', 'organization-delete',
      'profile-index', 'profile-create', 'profile-update', 'profile-delete',
      'auditorium-index', 'auditorium-create', 'auditorium-update', 'auditorium-delete',
      'auditorium-event-index', 'auditorium-event-create', 'auditorium-event-update', 'auditorium-event-delete',
      ...
      'song-index', 'song-create', 'song-update', 'song-delete',
